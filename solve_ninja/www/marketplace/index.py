...
from solve_ninja.api.leaderboard import get_city_wise_action_count, get_active_ninja_count, get_total_invested_hours, get_state_wise_user_count
...
def get_context(context):
	...
	context.city_wise_data = get_city_wise_action_count(page_length=10)